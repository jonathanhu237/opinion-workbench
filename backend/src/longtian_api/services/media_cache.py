...
from longtian_api.repositories.analysis_shared import AnalysisRepository
from longtian_api.services.enrichment_models import EnrichedContent, validate_handle
...
class MediaCache(AnalysisRepository):
    def __init__(self, database, *, clock=time.time):
        ...
        from longtian_api.services.media_retention import MediaRetention
