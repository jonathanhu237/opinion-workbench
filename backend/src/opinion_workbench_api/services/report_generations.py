...
from opinion_workbench_api.schemas.report_generations import GenerationControl
...
class ReportGenerationService:
    ...
    async def _control(self, generation_id, payload, *, show):
        async with self._admission:
            ...
            try:
                ...
                if self.platform_access is not None:
                    try:
                        ...
                        raise AnalysisError("platform_access_cooldown_active") from None
            ...
            permit = getattr(self.platform_access, "permit_explicit_resume", None)
            if callable(permit):
