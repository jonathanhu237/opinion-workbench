...
from opinion_workbench_api.repositories.topic_reports import (
    TopicReportRepository,
    observed_usage,
)
from opinion_workbench_api.schemas.ai_summaries import ModelRetryNotice
from opinion_workbench_api.schemas.topic_report_engine import CompletedOutput
from opinion_workbench_api.schemas.topic_reports import ACTIVE_REPORTS
from opinion_workbench_api.services.ai_analysis import AIAnalysisError
from opinion_workbench_api.services.ai_client import AICompletion, decode_model_json
    ...
    async def _execute_node(
        ...
        try:
            ...
            rate_limit_seen = any(
                ...
                == {
                    "node_id": node_id,
                    "stage": ("judgment" if call.kind == "judgment" else "composition"),
                }
                for event in (
