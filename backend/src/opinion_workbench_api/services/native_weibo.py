...
from opinion_workbench_api.search_platforms import is_valid_search_content_url
...
from opinion_workbench_api.services.enrichment_models import AcquisitionDiagnostic
...
from opinion_workbench_api.services.weibo_dom import (
    barrier,
    document,
    read_search_page,
    text_of,
            ...
            while True:
                ...
                if (
                    ...
                    if "before_access" in open_parameters or any(
                        ...
                        open_kwargs["before_access"] = before_xhs_detail_navigation
