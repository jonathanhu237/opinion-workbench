...
from opinion_workbench_api.schemas.platform_access import PlatformAccessSnapshot
...
class SearchBatchCreate(BaseModel):
    ...
    platforms: list[SearchPlatform] = Field(
        default_factory=lambda: list(SEARCH_PLATFORMS), min_length=1, max_length=5
    )
