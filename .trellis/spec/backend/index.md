...
| [Independent Initial Analysis](./initial-analysis-guidelines.md) | Global results, immutable prompts/evidence, uncapped explicit admission and workflow child adapter | Active |
| [Unified Opinion Automation](./automation-workflow-guidelines.md) | Fixed collection-to-analysis-to-report orchestration, task goals, durable retry, cancellation and task-scoped new content | Active |
| [Historical Fixed-Interval Collection](./collection-schedule-guidelines.md) | Retired v13 schedule route/lifecycle and preserved storage context | Historical |
| [Automatic Text Reports](./topic-report-guidelines.md) | Saved-evidence judgment/composition adapter, bounded text graphs, retry, usage and source history | Active |
| [Homepage Workbench](./workbench-guidelines.md) | Read-only automation duty snapshot, current-owner attention, latest readable report, polling and UI truthfulness | Active |
